"""
    ...
    INPUT:
        ...
        - Database name 
        - Collection name 
        - Field and value (if querrying / input through STDIN)
        - Path of the CSV (if importing)
        - Interval of rows and exact columns to import (if importing)
    OUTPUT:
        - All objects that have the key value pair inputted (if querrying)
...
[Malek Miled] 29.03.2024
"""
from importCSV import importToMongoDB
from query import queryFromMongoDB
    ...
    try:
        ...
        with SSHTunnelForwarder(
            ...
            if int(input("Input 1 if you want to import a CSV to the mongoDB, 0 to querry: ")) == 1:
                ...
                result = queryFromMongoDB(client)
